...
#endif
static const char *ng0 = "/home/co-eda/Verilog/Pre/p6/DE.v";
...
LAB34:    xsi_vlog_unsigned_bit_combine(t3, 16, t112, 16, t126, 16);
    goto LAB38;
...
LAB69:    xsi_vlog_unsigned_bit_combine(t126, 16, t236, 16, t250, 16);
    goto LAB73;
...
LAB38:    t499 = (t0 + 6256);
    ...
    *((unsigned int *)t509) = (t511 | t505);
    xsi_driver_vfirst_trans(t499, 0, 7);
    t512 = (t0 + 6032);
    *((int *)t512) = 1;
...
LAB34:    xsi_vlog_unsigned_bit_combine(t3, 8, t112, 8, t126, 8);
    goto LAB38;
...
LAB97:    if (*((unsigned int *)t349) != 0)
        goto LAB98;

LAB99:    t356 = (t251 + 4);
    t357 = *((unsigned int *)t251);
...
LAB69:    xsi_vlog_unsigned_bit_combine(t126, 8, t236, 8, t250, 8);
    goto LAB73;
...
LAB90:    if (*((unsigned int *)t310) != 0)
        goto LAB91;

LAB92:    t318 = *((unsigned int *)t270);
...
LAB93:    t329 = *((unsigned int *)t317);
    t330 = *((unsigned int *)t323);
    *((unsigned int *)t317) = (t329 | t330);
    t331 = (t270 + 4);
    t332 = (t309 + 4);
    t333 = *((unsigned int *)t270);
    t334 = (~(t333));
...
LAB104:    xsi_vlog_unsigned_bit_combine(t250, 8, t360, 8, t374, 8);
    goto LAB108;

LAB106:    memcpy(t250, t360, 8);
    goto LAB108;
...
LAB121:    *((unsigned int *)t417) = 1;

LAB123:    memset(t433, 0, 8);
    t434 = (t417 + 4);
...
LAB125:    if (*((unsigned int *)t434) != 0)
        goto LAB126;

LAB127:    t442 = *((unsigned int *)t394);
...
LAB128:    t453 = *((unsigned int *)t441);
    t454 = *((unsigned int *)t447);
    *((unsigned int *)t441) = (t453 | t454);
    t455 = (t394 + 4);
    t456 = (t433 + 4);
    t457 = *((unsigned int *)t394);
    t458 = (~(t457));
...
LAB137:    t498 = ((char*)((ng2)));
    goto LAB138;

LAB139:    xsi_vlog_unsigned_bit_combine(t374, 8, t484, 8, t498, 8);
    goto LAB143;

LAB141:    memcpy(t374, t484, 8);
    goto LAB143;
...
LAB50:    xsi_vlog_unsigned_bit_combine(t87, 32, t118, 32, t137, 32);
    goto LAB54;
...
extern void work_m_14946410480360448923_2694143388_init()
{
	static char *pe[] = {(void *)Cont_37_0,(void *)Cont_40_1,(void *)Cont_45_2,(void *)NetDecl_49_3,(void *)NetDecl_52_4,(void *)NetDecl_56_5,(void *)Cont_59_6};
	xsi_register_didat("work_m_14946410480360448923_2694143388", "isim/mips_isim_beh.exe.sim/work/m_14946410480360448923_2694143388.didat");
